...
interface SoalContracts {
    interface Presenter : BasePresenter {
        ...
        fun sendTWK(idSoal : String, pilihan : String, idHistory: String)

        fun sendTIU(idSoal : String, pilihan : String, idHistory: String)

        fun sendTKP(idSoal : String, pilihan : String, idHistory: String)
