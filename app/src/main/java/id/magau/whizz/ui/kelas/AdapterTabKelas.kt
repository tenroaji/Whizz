...
class AdapterTabKelas(private val idProduct: String,fm: FragmentManager, private val kelasSaya : Boolean,private val streaming : ArrayList<ModelStreaming?>?) : FragmentPagerAdapter(fm) {

    override fun getItem(position: Int): Fragment =
        when (position) {
        0 -> MateriFragment.newInstance(idProduct,kelasSaya,streaming)
