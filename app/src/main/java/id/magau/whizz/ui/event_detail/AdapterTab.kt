...
class AdapterTab(fm: FragmentManager,private val idEvent : String,private val tanggal :String, private val waktu : String,
                 private val alamat:String, private val kota : String,private val pemateri : List<ModelPemateri>) : FragmentPagerAdapter(fm) {

    override fun getItem(position: Int): Fragment = when (position) {
        0 -> JadwalFragment.newInstance(tanggal,waktu,kota,alamat)
        1 -> MentorFragment.newInstance(pemateri)
        else -> MentorFragment()
    }
