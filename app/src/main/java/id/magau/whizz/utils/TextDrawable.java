...
public class TextDrawable extends ShapeDrawable {
    ...
    public static class Builder implements IConfigBuilder, IShapeBuilder, IBuilder {
        ...
        private Builder(Context context) {
            ...
            height = -1;
            shape = new RectShape();
            font = Typeface.create(ResourcesCompat.getFont(context, R.font.muli_bold_family), Typeface.NORMAL);
//            font = ResourcesCompat.getFont(context, R.font.nunito_sans_family);
            fontSize = -1;
            isBold = false;
            toUpperCase = false;
        }
        ...
        @Override
        public TextDrawable buildRound(String text, int color, int heigth, int width) {
            this.width = width;
            this.height = heigth;
            round();
            return build(text, color);
    ...
    public interface IShapeBuilder {
        ...
        TextDrawable buildRound(String text, int color, int heigth, int width);
    }
}
